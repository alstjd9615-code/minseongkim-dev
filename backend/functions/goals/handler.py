"""
Goals Lambda handler – stores and tracks personal goals.

POST   /goals               → create a goal (requires Cognito auth)
GET    /goals               → list user's goals
PUT    /goals/{goalId}      → update goal status/progress
...
GOALS_TABLE = os.environ.get("GOALS_TABLE", "lifemanager-goals")

VALID_PERIODS = {"단기", "장기"}
VALID_STATUSES = {"진행중", "완료", "포기"}
...
def handler(event: dict[str, Any], context: Any) -> dict[str, Any]:  # noqa: ARG001
    ...
    goal_id: str | None = path_params.get("goalId")
    ...
    if http_method == "POST":
        ...
        if period not in VALID_PERIODS:
            return _response(400, {"message": "Invalid period. Must be 단기 or 장기"})
        ...
        try:
            ...
            return _response(500, {"message": "Failed to save goal"})
    ...
    if http_method == "GET":
        ...
        try:
            ...
            return _response(500, {"message": "Failed to retrieve goals"})
    ...
    if http_method == "PUT":
        ...
        if not user_id:
            return _response(401, {"message": "Unauthorised"})
        if not goal_id:
            return _response(400, {"message": "goalId is required"})
        ...
        try:
            ...
            return _response(404, {"message": "Goal not found"})
        except ClientError as exc:
            logger.error("DynamoDB update_item error: %s", exc)
            return _response(500, {"message": "Failed to update goal"})
    ...
    if http_method == "DELETE":
        ...
        try:
            ...
            return _response(500, {"message": "Failed to delete goal"})
